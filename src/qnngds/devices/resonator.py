...
#
#
# def compute_veff(e_eff: float) -> float:
#    """Computes effective light speed from effective permittivity.
#
#    Args:
#        e_eff: relative effective permittivity
#
#    Returns:
#        (float): effective phase velocity in m/s
#    """
#    return scipy.constants.c / np.sqrt(e_eff)
#
#
# def compute_res_wavelength(e_eff: float, res_freq: float) -> float:
...
#    optimal_width = 0.1
#
#    taper_init = pg.optimal_step(width, width * (1 + optimal_width), layer=layer, symmetric=True)
...
#    qp(transmission_line_resonator(tl_width=20, tl_length=100, meander_width=5, meander_e_eff=100, res_freq=20e9, turn_radius=5))
